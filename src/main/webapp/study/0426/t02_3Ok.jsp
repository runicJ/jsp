...
%>
<jsp:useBean id="vo" class="study.j0426.T02VO" />  <!-- VO에 기본 생성자가 있어야함 //  JVO vo = new JVO();와 같음 // 클래스선언기호 클래스변수명 = new 클래스 // class=클래스경로와 id=클래스변수명 외부 객체 사용하기 위해서 외부 클래스 정의 // Bin or Bins(xml에서 클래스를 정의 할 때 사용) -->
<!-- 
...
<head>
  ...
  --%>
  <jsp:setProperty property="*" name="vo" />  <!-- 한번에 다가져옴 와일트카드(*) -->
</head>
<body>
